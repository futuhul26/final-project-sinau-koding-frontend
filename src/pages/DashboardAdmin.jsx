    ...
    <div className='flex min-h-screen bg-gray-100'>
      ...
      <main className='flex-1 p-6'>
        ...
        <form className='mb-6 flex flex-col space-y-3 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4'>
          <div className='flex-1'>
            ...
            <div className='relative'>
              <input
                type='date'
                id='start-date'
                className='w-full rounded-md border border-gray-200 px-4 py-3 text-xs text-gray-400 placeholder-gray-400'
          ...
          <button
            type='submit'
            className='w-sm rounded-lg bg-orange-500 py-2 font-semibold text-white transition duration-200 hover:bg-orange-600 sm:self-auto'
          >
            Search
          </button>
        </form>
